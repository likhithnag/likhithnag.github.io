      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        ...
        >
          <motion.span
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-border text-sm font-medium text-chrome-dark mb-4"
          >
          ...
          <motion.h1
            ...
            className="hero-heading font-kanit font-bold text-5xl md:text-7xl lg:text-8xl leading-tight mb-4"
          >
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-chrome-light/70 max-w-3xl mx-auto mb-6 leading-relaxed no-wrap-words"
          >
            {profile.tagline}
          </motion.p>
        ...
        <motion.div
          ...
          className="absolute bottom-4 left-1/2 -translate-x-1/2 animate-bounce md:bottom-8"
        >
          <button
